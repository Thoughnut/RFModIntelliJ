...
public enum ModArmorMaterial implements IArmorMaterial {
    ...
    RF("rf",36, new int[] { 3, 5, 7, 3}, 36, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND
            , 2.5F, 0.05F, () -> {return Ingredient.fromItems(ModItems.RFINGOT.get());
    });
